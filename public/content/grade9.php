<div class="container">
	...
	<div class="row" style="background:white; margin-top:20px;">
		...
		<div class="col-sm-8">
			...
			<img src="public/img/backtoschool.jpg" style="width:100%;">
			<h1 style="border-bottom:solid 1px black;">Grade 9 Articles</h1>
            
  
        <?php include('public/content/abellana.php');?> 
        <?php include('public/content/dumayac1.php');?> 
        <?php include('public/content/dumayac2.php');?>   
